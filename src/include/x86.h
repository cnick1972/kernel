 ...
 */
void KERNEL_CDECL x86_InvalidatePage(uint8_t page);

/**
 * @brief Reload the current page directory (flushes the entire TLB).
 */
void KERNEL_CDECL x86_ReloadPageDirectory();
 ...
 */
uint8_t KERNEL_CDECL x86_EnableInterrupts();
 ...
 * @return Previous interrupt flag state.
 */
uint8_t KERNEL_CDECL x86_DisableInterrupts();
 ...
 */
uint32_t KERNEL_CDECL x86_CR2_register();
