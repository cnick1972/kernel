...
for i in $(seq 0 255); do
    echo "void __attribute__((cdecl)) i386_ISR${i}();" >> $ISRS_GEN_C
done

echo "" >> $ISRS_GEN_C
echo "void i386_ISR_InitializeGates()" >> $ISRS_GEN_C
echo "{" >> $ISRS_GEN_C

for i in $(seq 0 255); do
    echo "    i386_IDT_SetGate(${i}, i386_ISR${i}, i386_GDT_CODE_SEGMENT, IDT_FLAG_RING0 | IDT_FLAG_GATE_32BIT_INT);" >> $ISRS_GEN_C
done
